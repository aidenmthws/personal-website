...
const Features = () => {
  ...
  return (
    <div className="py-0" id="features">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> {/* Increased max-w */}
        ...
        <div className="mt-10">
          <dl className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-16 justify-items-center"> {/* Added responsive grid */}

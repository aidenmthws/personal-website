...
const MainHero = () => {
  ...
  return (
    <main className="mt-10 mx-auto px-8 sm:mt-0 sm:px-12 md:mt-16 lg:mt-20 xl:mt-28 mb-0" style={{ marginBottom: '-150px' }}>
      <div className="text-left">
        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
          <span className="block">{mainHero.title}</span>{' '}
          <span className="block text-primary">{mainHero.subtitle}
